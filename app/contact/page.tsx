...
const socials = [
  ...
  },
  {
    ...
    href: "https://www.linkedin.com/in/talkshrey/",
    label: "LinkedIn",
    handle: "talkshrey",
  },
];
          ...
          {socials.map((s) => (
            <Card>
              <Link
                href={s.href}
                target="_blank"
                className="p-3 relative flex flex-col items-center gap-4 duration-700 group md:gap-8 md:py-24 lg:pb-24 md:p-16"
              >
                <span
                  className="absolute w-px h-1/2 bg-gradient-to-b from-zinc-500 via-zinc-500/50 to-transparent"
                  aria-hidden="true"
                />
                ...
                <div className="z-10 flex flex-col items-center">
                  <span className="lg:text-base font-medium duration-150 xl:text-2xl text-zinc-200 group-hover:text-white font-display">
                    {s.handle}
                  </span>
